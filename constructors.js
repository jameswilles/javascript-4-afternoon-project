...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  User.prototype.addSavedPost = function(id, title, rating) {
    ...
    let newSave = new Post(id, title, rating)
  ...
  // Code here
  User.prototype.removeSavedPost = function(idInput) {
    for(i=0; i<this.savedPosts.length; i++) {
      if (this.savedPosts[i].id === idInput) {
  ...
  // Code here
  User.prototype.changePostRating = function(idInput, newRating) {
    for(i=0; i<this.savedPosts.length; i++) {
      if(this.savedPosts[i].id === idInput) {
